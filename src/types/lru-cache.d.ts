// THIS FILE ISN'T ACTUALLY USED! It's copied directly into node_modules! TODO REMEMBER TO OPEN PR in Definitely typed!
...
declare interface LRU<T> extends LRU.Cache<T> {
}

declare class LRU<T> {
  constructor(opts: LRU.Options<T> | number);
}
